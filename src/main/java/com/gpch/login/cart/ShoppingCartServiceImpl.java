...
@Service
@Scope(value = WebApplicationContext.SCOPE_SESSION,proxyMode = ScopedProxyMode.TARGET_CLASS)//Read about this
@Transactional
...
private Map<Product,Integer> cart = new LinkedHashMap<>();
    ...
    public Map<Product, Integer> productsInCart() {
        return Collections.unmodifiableMap(cart); //?Read
    }
