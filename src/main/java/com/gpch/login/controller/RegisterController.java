...
import com.gpch.login.user.UserValidator;
...
public class RegisterController {
    ...
    public String registration(@ModelAttribute("userForm") User userFrom, BindingResult bindingResult){
        ...
        if (bindingResult.hasErrors()){
            logger.debug(String.valueOf(bindingResult.getFieldError()));
            return  "register";
        }
        userService.save(userFrom);
        userService.login(userFrom.getUsername(),userFrom.getPasswordConfirm());
